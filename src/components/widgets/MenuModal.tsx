          ...
          >
            {item.hasSubmenu ? (
              <>
                <button
                  class={cn(
                    "!text-3xl font-medium text-gray-700 dark:text-gray-200 flex items-center justify-between w-full p-2.5 px-5",
                    isActive &&
                ...
                <div
                  class={cn(
                    "text-3xl text-muted-foreground transition-all duration-500 ease-in-out max-h-0 overflow-hidden",
                      ...
                      return (
                        <li key={subitem.title} class="flex items-center">
                          ...
                          <a
                            href={subitem.href}
                            class={cn(
                              "block text-gray-700 dark:text-gray-200 !text-3xl p-3 pl-1 font-medium transition-all duration-200",
                              isSubitemActive &&
                              "bg-primary-100 dark:bg-primary-100/80 !important text-primary-800 dark:text-secondary-800 !important font-bold !important",
              ...
              <a
                href={item.href}
                class={cn(
                  "block lg text-gray-700 !text-3xl !text-white dark:text-gray-200 p-3 px-5 font-medium transition-all duration-200",
                  isActive &&
